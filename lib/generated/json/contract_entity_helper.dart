...
contractEntityFromJson(ContractEntity data, Map<String, dynamic> json) {
  ...
  if (json['thirdPartyIdCard'] != null) {
    data.thirdPartyIdCard = json['thirdPartyIdCard'].toString();
  }
  if (json['thirdPartyMob'] != null) {
    data.thirdPartyMob = json['thirdPartyMob'].toString();
  }
  if (json['thirdPartyName'] != null) {
    data.thirdPartyName = json['thirdPartyName'].toString();
  }
  ...
  if (json['macAddress'] != null) {
    data.macAddress = json['macAddress'];
  }
